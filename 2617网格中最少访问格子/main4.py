        ...
        while queue:
            ...
            for i in range(num_jump):
                if vertex[0]+i+1 >= self.line:
                    ...
                    if (self.grid[vertex[0]+i+1, vertex[1]] != 0) and (self.grid[vertex[0]+i+1, vertex[1]] not in np.array(queue)):
            ...
            for i in range(num_jump):
                if vertex[1]+i+1 >= self.col:
                    ...
                    if (self.grid[vertex[0], vertex[1]+i+1] != 0) and (self.grid[vertex[0], vertex[1]+i+1] not in np.array(queue)):
